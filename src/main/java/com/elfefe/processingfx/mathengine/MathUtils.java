...
public final class MathUtils {
     ...
     *
     * @param z The size of the set
     * @param w the size of the subsets to count
     * @return z choose w
     */
     ...
     *
     * @param xval The first number
     * @param yval The second number
     ...
     * @param x       The first number
     * @param y       The second number
     * @param perCent The percentage limit to use
     ...
     * @param r the size of the subsets to count
